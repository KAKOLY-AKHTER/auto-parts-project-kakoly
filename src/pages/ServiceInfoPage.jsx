  ...
  return (
    <div style={{ background:"#080808", color:"#fff", minHeight:"100vh" }}>
      ...
      <section style={{ position:"relative", minHeight:580, display:"flex", alignItems:"center", overflow:"hidden" }}>
        ...
        <div style={{ position:"relative", zIndex:2, maxWidth:1400, margin:"0 auto", padding:"90px 80px 80px", width:"100%" }}>
      ...
      {/* ══════════ SPLIT: IMAGE + CARDS ══════════ */}
      {cards.length > 0 && (
        <section style={{ background:"#0c0c12", padding:"80px 0" }}>
          <div style={{ maxWidth:1400, margin:"0 auto", padding:"0 80px" }}>
            <div style={{ display:"grid", gridTemplateColumns: sectionImg ? "1.15fr 1fr" : "1fr", gap:60, alignItems:"start" }}>
              ...
              {/* RIGHT: image panel */}
              {sectionImg && (
                <div style={{ position:"sticky", top:120, ...a("siRight",0.1) }}>
      ...
      {/* ══════════ CTA ══════════ */}
      <section style={{ position:"relative", overflow:"hidden", padding:"80px" }}>
        {ctaImg && (
        ...
        <div style={{ position:"relative",zIndex:2,maxWidth:1400,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:32 }}>
