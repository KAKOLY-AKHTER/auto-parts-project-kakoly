...
const services = [
  { color: "#dc2626", icon: "🔄", title: "Tire Installation",  price: "From $25/tire",   time: "30–60 min", popular: true,  desc: "Mount, balance & TPMS reset. All major brands: Michelin, Goodyear, Cooper, Bridgestone." },
  { color: "#f59e0b", icon: "🛢️",  title: "Oil Change",         price: "From $39.99",     time: "20–30 min", popular: true,  desc: "Conventional, blend, or full synthetic with filter replacement and 21-point inspection." },
  { color: "#3b82f6", icon: "⚙️",  title: "Wheel Alignment",    price: "From $79.99",     time: "45–60 min", popular: false, desc: "2-wheel & 4-wheel alignment with Hunter equipment. Improves handling and tire life." },
  { color: "#10b981", icon: "↩️",  title: "Tire Rotation",      price: "From $19.99",     time: "20–30 min", popular: false, desc: "Regular rotation extends tire life. Recommended every 5,000–7,500 miles." },
  { color: "#8b5cf6", icon: "🛑",  title: "Brake Service",      price: "From $99/axle",   time: "60–90 min", popular: false, desc: "Pad, rotor & caliper service. Premium OEM-grade parts with 12-month warranty." },
  { color: "#ec4899", icon: "🔋",  title: "Battery Service",    price: "From $129.99",    time: "20–30 min", popular: false, desc: "Battery testing, charging system check & replacement. Free test with any service." },
  { color: "#06b6d4", icon: "🔩",  title: "Tire Repair",        price: "From $15",        time: "15–20 min", popular: true,  desc: "Plug & patch repairs for most punctures in under 20 minutes. Walk-ins welcome." },
  { color: "#84cc16", icon: "✅",  title: "21-Point Inspection", price: "Free w/ service", time: "15–20 min", popular: false, desc: "Comprehensive safety check: tires, brakes, lights, fluids, belts, and hoses." },
];
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {services.map(({ color, icon, title, price, time, popular, desc }) => (
              <div key={title}
                className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative group cursor-pointer">
                {popular && (
