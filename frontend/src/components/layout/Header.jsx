...
const navItems = [
  { label: "Home", href: "/" },
  {
    ...
    children: [
      { icon: "fa-circle-dot",     label: "Tire Service & Repair",  href: "/tire-service" },
      { icon: "fa-oil-can",        label: "Oil Change",             href: "/oil-change" },
      { icon: "fa-circle-stop",    label: "Brake Repair",           href: "/brake-repair" },
      { icon: "fa-rotate",         label: "Wheel Alignment",        href: "/wheel-alignment" },
      { icon: "fa-battery-half",   label: "Battery Replacement",    href: "/battery-replacement", dividerBefore: true },
      { icon: "fa-snowflake",      label: "A/C Evaluation",         href: "/ac-evaluation" },
    ],
  },
  {
    label: "Fleet & Mobile", href: "/fleet-services",
    children: [
      { icon: "fa-truck",          label: "Truck Tire Change",              href: "/truck-tire-change" },
      { icon: "fa-trailer",        label: "Trailer Tire Change",            href: "/trailer-tire-change" },
      { icon: "fa-oil-can",        label: "Oil Change",                     href: "/oil-change" },
      { icon: "fa-road",           label: "Roadside Assistance",            href: "/roadside-assistance" },
      { icon: "fa-location-dot",   label: "Mobile Service at Your Location",href: "/mobile-service", dividerBefore: true },
      { icon: "fa-clock",          label: "Available 24/7",                 href: "/emergency-service" },
    ],
  },
  {
                ...
                >
                  ...
                  <div className="flex flex-col gap-1 mb-3">
                    {[
                      ...
                      { href: "/dashboard",           icon: "fa-box",                label: "My Orders" },
                      { href: "/dashboard",           icon: "fa-screwdriver-wrench", label: "Service Requests" },
                      { href: "/dashboard",           icon: "fa-user",               label: "Profile" },
                    ].map(({ href, icon, label }) => (
                      <a key={label} href={href}
                        className="flex items-center gap-3 px-3 py-2.5 rounded-lg no-underline"
                        style={{ color: "#fff", fontFamily: "'Oswald',sans-serif", fontSize: 14, fontWeight: 600, letterSpacing: "0.05em", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", transition: "all 0.18s ease" }}
                        onMouseEnter={e => { e.currentTarget.style.background = "rgba(227,6,19,0.15)"; e.currentTarget.style.borderColor = "rgba(227,6,19,0.35)"; }}
                        onMouseLeave={e => { e.currentTarget.style.background = "rgba(255,255,255,0.04)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.07)"; }}
                      >
                        <div style={{ width: 30, height: 30, borderRadius: 7, background: "rgba(227,6,19,0.15)", border: "1px solid rgba(227,6,19,0.4)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                          <i className={`fas ${icon}`} style={{ color: "#ff2030", fontSize: 12 }} />
                        </div>
                        {label}
                      </a>
                    ))}
