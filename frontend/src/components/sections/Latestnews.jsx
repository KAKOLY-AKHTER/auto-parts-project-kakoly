  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 right-3 z-10 flex gap-2 translate-x-3 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-400">
        <a href={post.href} className="w-9 h-9 flex items-center justify-center bg-white/90 backdrop-blur-md hover:bg-red-600 text-gray-600 hover:text-white rounded-lg border border-gray-200 hover:border-red-600 transition-all duration-300 shadow-sm" title="Read Article">
