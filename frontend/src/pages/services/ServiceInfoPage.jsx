const CSS = `
  ...
  /* header-clearing for fixed nav */
  .si-hero-section { padding-top: 152px !important; }
  @media(min-width:768px)  { .si-hero-section { padding-top: 196px !important; } }
  @media(min-width:1024px) { .si-hero-section { padding-top: 208px !important; } }

  .si-hero-pad { padding:16px 20px 40px; width:100%; }
  @media(min-width:640px)  { .si-hero-pad { padding:20px 36px 48px; } }
  @media(min-width:1024px) { .si-hero-pad { padding:24px 80px 60px; } }
...
export default function ServiceInfoPage({
  ...
  return (
    <div style={{ background:"#080808", color:"#fff", minHeight:"100vh" }}>
      ...
      {/* ══════════ HERO ══════════ */}
      <section className="si-hero-section" style={{ position:"relative", minHeight:460, display:"flex", alignItems:"flex-start", overflow:"hidden" }}>
        {/* bg image */}
